...
class AddBankProvider with ChangeNotifier {
  Future<Map<String, dynamic>> addBank(String accountNumber, String bankName,
      String accountName, String bvn) async {
    var result;
    ...
    String url = "https://ezopurze.herokuapp.com/api/add/account/$id";
    Response response = await post(Uri.parse(url),
        body: json.encode(addBankData),
        headers: {
    ...
    if (response.statusCode == 200) {
      ...
      if (addBank.user.terms == true) {
        ...
        result = {
          ...
          'add': AddBankModel.fromJson(responseData)
        };
      } else {
