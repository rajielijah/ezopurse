...
AddBank addBankFromJson(String str) => AddBank.fromJson(json.decode(str));

String addBankToJson(AddBank data) => json.encode(data.toJson());
...
class AddBank {
    ...
    factory AddBank.fromJson(Map<String, dynamic> json) => AddBank(
        status: json["status"],
